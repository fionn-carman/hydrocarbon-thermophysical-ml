...
# Load the dataset for Density at 40°C
file_path = "Datasets/Density_40C_Dataset.csv"
...
def custom_grid_search(X, y, model, param_grid, cv=5):
    ...
    with open('grid_search_results_Density_40C.csv', mode='w', newline='') as file:
