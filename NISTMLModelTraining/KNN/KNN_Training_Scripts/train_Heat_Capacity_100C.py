...
# Load the dataset for Heat Capacity at 100°C
file_path = "Datasets/Heat_Capacity_100C_Dataset.csv"
...
y = data['Heat_Capacity_100C'].values
...
def custom_grid_search(X, y, model, param_grid, cv=5):
    ...
    with open('grid_search_results_Heat_Capacity_100C.csv', mode='w', newline='') as file:
