...
# Load the dataset for Thermal Conductivity at 100°C
file_path = "Datasets/Thermal_Conductivity_100C_Dataset.csv"
...
y = data['Thermal_Conductivity_100C'].values
...
def custom_grid_search(X, y, model, param_grid, cv=5):
    ...
    with open('grid_search_results_Thermal_Conductivity_100C.csv', mode='w', newline='') as file:
