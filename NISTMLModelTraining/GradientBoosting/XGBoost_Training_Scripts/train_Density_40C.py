...
RDS = False
if RDS:
    descriptors_df = pd.read_csv('/rds/general/user/eeo21/home/HIGH_THROUGHPUT_STUDIES/MLForTribology/Datasets/Density_40C_Train_Descriptors.csv')
    ...
    for n_estimators in param_grid['n_estimators']:
        for learning_rate in param_grid['learning_rate']:
            for max_depth in param_grid['max_depth']:
                ...
                results_df.to_csv('xgboost_Density_40C_training_results.csv', mode='a', header=not os.path.isfile('xgboost_Density_40C_training_results.csv'), index=False)
...
# Save the best model
dump(best_model, 'best_xgboost_model_Density_40C.joblib')
...
plt.title('Feature Importance for Density at 40°C')
plt.savefig('feature_importance_Density_40C.png')
plt.show()
