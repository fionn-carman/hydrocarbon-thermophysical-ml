...
property_name = "Viscosity_40C"
dataset = pd.read_csv("/rds/general/user/eeo21/home/HIGH_THROUGHPUT_STUDIES/MLForTribology/Datasets/LandoltNISTDatasets/Viscosity_40C_Train.csv")
test_dataset = pd.read_csv("/rds/general/user/eeo21/home/HIGH_THROUGHPUT_STUDIES/MLForTribology/Datasets/LandoltNISTDatasets/Viscosity_40C_Test.csv")
...
# Save the best model
best_model.save(f"best_cnn_model_Viscosity_40C.h5")

# Evaluate the model on test data
y_pred = best_model.predict(X_test)
mse = mean_squared_error(y_test, y_pred)
print(f"Test MSE for Viscosity_40C: {mse}")
