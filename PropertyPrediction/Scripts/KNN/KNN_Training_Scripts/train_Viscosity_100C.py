...
# Load the dataset for Viscosity at 100°C
file_path = "Datasets/Viscosity_100C_Dataset.csv"
...
def custom_grid_search(X, y, model, param_grid, cv=5):
    ...
    with open('grid_search_results_Viscosity_100C.csv', mode='w', newline='') as file:
