...
# Load the dataset for Thermal Conductivity at 40°C
file_path = "Datasets/Thermal_Conductivity_40C_Dataset.csv"
...
y = data['Thermal_Conductivity_40C'].values
...
def custom_grid_search(X, y, model, param_grid, cv=5):
    ...
    with open('grid_search_results_Thermal_Conductivity_40C.csv', mode='w', newline='') as file:
